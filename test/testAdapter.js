...
var adapterShortNameLog = adapterShortName + ' Config Normal (' + setup.getCurrentTimezoneName() + ')';
    ...
    it('Test ' + adapterShortNameLog + ': data.table', function (done) {
        ...
        setTimeout(function () {
            states.getState('ical.0.data.table', function (err, state) {
                ...
                expect(state.val[0].date).to.endsWith('. 02:00');
                ...
                expect(state.val[1].date).to.endsWith('. 00:00');
                ...
                expect(state.val[2].date).to.endsWith('. 00:00');
