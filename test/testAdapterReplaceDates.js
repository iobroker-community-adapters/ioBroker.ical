...
var adapterShortNameLog = adapterShortName + ' Config Replace Dates (' + util.getCurrentTimezoneName() + ')';
...
describe('Test ' + adapterShortNameLog + ' adapter', function() {
    ...
    it('Test ' + adapterShortNameLog + ': data.table', function (done) {
        ...
        states.getState('ical.0.data.table', function (err, state) {
            ...
            expect(state.val[2].date).to.be.oneOf([' 1 day left', ' 2 days left']);
            ...
            //expect(state.val[3].date).to.be.equal('Today 23:58-23:59'); TZ Conversion, TODO
            expect(state.val[3].date).to.startsWith('Today ');
            expect(state.val[3].date).to.endsWith(':59');
            ...
            //expect(state.val[7].date).to.be.equal('Tomorrow 19:30-20:30'); TZ Conversion, TODO
            expect(state.val[7].date).to.startsWith('Tomorrow ');
